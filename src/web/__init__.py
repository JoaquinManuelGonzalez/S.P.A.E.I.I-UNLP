...
from src.core.services.postulacion_service import postulaciones_pendientes_presidencia, postulaciones_pendientes_focal, obtener_postulacion_actual_de_alumno, puede_postularse
