...
def listado_asignar_asignaturas(carrera_id):
    ...
    facultades = facultades_service.get_all_facultades()
    return render_template("carreras/asignatura_carrera.html", facultades=facultades, asignaturas=asignaturas, search=search, facultad_id=facultad_id, pagina=pagina, carrera=carrera)
...
def asignar_asignatura(carrera_id, asignatura_id):
    ...
    return redirect(url_for("carreras.listado_asignar_asignaturas", carrera_id = carrera_id))
...
def desasignar_asignatura(carrera_id, asignatura_id):
    ...
    return redirect(url_for("carreras.visualizar", carrera_id = carrera_id))